        ...
        <>
            <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                    ...
                    {/* Explain concept */}
                    <div className="group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
                        <form onSubmit={handleExplainConcept} className="">
                            ...
                            <div className="flex items-center gap-3">
                                <input
                                    type="text"
                                    className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-purple-500/10"
                                    value={concept}
